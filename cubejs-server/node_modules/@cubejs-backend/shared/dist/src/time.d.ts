...
declare const moment: import("moment-range").MomentRange & typeof import("moment");
...
export declare function addInterval(date: moment.Moment, interval: ParsedInterval): moment.Moment;
export declare function subtractInterval(date: moment.Moment, interval: ParsedInterval): moment.Moment;
/**
 * Returns the closest date prior to date parameter aligned with the origin point
 */
export declare const alignToOrigin: (startDate: moment.Moment, interval: ParsedInterval, origin: moment.Moment) => moment.Moment;
export declare const parsedSqlIntervalToDuration: (parsedInterval: ParsedInterval) => moment.Duration;
export declare const timeSeriesFromCustomInterval: (intervalStr: string, [startStr, endStr]: QueryDateRange, origin: moment.Moment, options?: TimeSeriesOptions) => QueryDateRange[];
/**
 * Returns array of date ranges for a predefined granularity aligned with the start of the year as pivot point
 */
export declare const timeSeries: (granularity: string, dateRange: QueryDateRange, options?: TimeSeriesOptions) => QueryDateRange[];
export declare const isPredefinedGranularity: (granularity: string) => boolean;
export declare const FROM_PARTITION_RANGE = "__FROM_PARTITION_RANGE";
 ...
 */
export declare const localTimestampToUtc: (timezone: string, timestampFormat: string, timestamp?: string) => string | null;
/**
...
export declare const parseUtcIntoLocalDate: (data: {
    [key: string]: string;
...
export declare const reformatInIsoLocal: (timestamp: string) => string;
export {};
