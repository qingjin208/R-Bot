...
async function downloadAndExtractFile(url, { cwd, skipExtract, dstFileName }) {
    ...
    if (skipExtract) {
        ...
        await (0, decompress_1.default)(savedFilePath, cwd);
    }
    try {
