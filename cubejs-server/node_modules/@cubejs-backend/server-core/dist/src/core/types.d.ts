...
import { CheckAuthFn, ExtendContextFn, JWTOptions, UserBackgroundContext, QueryRewriteFn, CheckSQLAuthFn, CanSwitchSQLUserFn, ContextToApiScopesFn } from '@cubejs-backend/api-gateway';
...
export type DatabaseType = 'cubestore' | 'athena' | 'bigquery' | 'clickhouse' | 'crate' | 'druid' | 'jdbc' | 'firebolt' | 'hive' | 'mongobi' | 'mssql' | 'mysql' | 'elasticsearch' | 'awselasticsearch' | 'oracle' | 'postgres' | 'prestodb' | 'redshift' | 'snowflake' | 'sqlite' | 'questdb' | 'materialize' | 'pinot';
...
export type ServerCoreInitializedOptions = Required<DriverDecoratedOptions, 'dbType' | 'apiSecret' | 'devServer' | 'telemetry' | 'dashboardAppPath' | 'dashboardAppPort' | 'schemaPath' | 'driverFactory' | 'dialectFactory' | 'externalDriverFactory' | 'externalDialectFactory' | 'scheduledRefreshContexts'>;
