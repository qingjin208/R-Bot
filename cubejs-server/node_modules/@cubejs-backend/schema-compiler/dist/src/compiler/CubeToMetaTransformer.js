...
class CubeToMetaTransformer {
    ...
    transform(cube) {
        ...
        const flatFolderSeparator = (0, shared_1.getEnv)('nestedFoldersDelimiter');
        const flatFolders = [];
        ...
        return {
            config: {
                ...
                dimensions: ramda_1.default.compose(ramda_1.default.map((nameToDimension) => ({
                    ...
                    suggestFilterValues: nameToDimension[1].suggestFilterValues == null
                        ? true
                    ...
                    granularities: nameToDimension[1].granularities
                        ? ramda_1.default.compose(ramda_1.default.map((g) => ({
                            name: g[0],
                            title: this.title(cubeTitle, g, true),
                            interval: g[1].interval,
                            offset: g[1].offset,
                            origin: g[1].origin,
                        })), ramda_1.default.toPairs)(nameToDimension[1].granularities)
                        : undefined,
    ...
    queriesForContext(contextId) {
        ...
        return ramda_1.default.filter((query) => ramda_1.default.includes(query.config.name, context.contextMembers))(this.queries);
    }
    /**
     * @protected
     */
    ...
    measureConfig(cubeName, cubeTitle, nameToMetric) {
        ...
        const type = CubeSymbols_1.CubeSymbols.toMemberDataType(nameToMetric[1].type);
        return {
            name,
    ...
    titleize(name) {
        return inflection_1.default.titleize(inflection_1.default.underscore((0, camelcase_1.default)(name, { pascalCase: true })));
    }
}
