...
class PackageFetcher {
    ...
    async manifestJSON() {
        const response = await (0, utils_1.proxyFetch)(`https://api.github.com/repos/${this.repo.owner}/${this.repo.name}/contents/manifest.json`);
    ...
    async downloadRepo() {
        ...
        (await (0, utils_1.proxyFetch)(url)).body.pipe(writer);
    ...
    async downloadPackages() {
        ...
        await (0, decompress_1.default)(this.repoArchivePath, this.tmpFolderPath, {
            plugins: [(0, decompress_targz_1.default)()],
        });
        ...
        await (0, shared_1.executeCommand)('npm', ['install'], { cwd: path_1.default.resolve(this.tmpFolderPath, dir) });
        return {
