...
class SourceContainer {
    ...
    constructor(sourceFiles) {
        this.fileContent = (0, ramda_1.fromPairs)(sourceFiles.map(({ fileName, content }) => [fileName, content]));
    }
    ...
    addImportDependencies(importDependencies = {}) {
        ...
        const specificDependencies = (0, ramda_1.fromPairs)(Object.keys(importDependencies)
            .map((name) => {
    ...
    outputSources() {
        return (0, ramda_1.toPairs)(this.fileContent).map(([fileName, content]) => ({
            fileName,
            content,
        }));
    }
