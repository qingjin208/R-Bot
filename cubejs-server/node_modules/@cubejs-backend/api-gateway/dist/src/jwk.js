...
const createJWKsFetcher = (jwtOptions, options) => {
    const fetchJwkUrl = (0, shared_1.asyncMemoizeBackground)(async (url) => {
        const response = await (0, shared_1.asyncRetry)(async () => (0, node_fetch_1.default)(url, { agent: await (0, shared_1.getHttpAgentForProxySettings)() }), {
        ...
        for (const jwk of json.keys) {
            ...
            result.set(jwk.kid, (0, jwk_to_pem_1.default)(jwk));
        }
        let lifeTime = 0;
