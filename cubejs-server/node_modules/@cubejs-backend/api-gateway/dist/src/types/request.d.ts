 ...
 */
type ExtendedRequestContext = RequestContext & RequestExtension;
/**
 ...
 */
type QueryRewriteFn = (query: Query, context: RequestContext) => Promise<Query>;
/**
 ...
 * @todo Maybe we can add type limitations?
 */
type SecurityContextExtractorFn = (ctx: Readonly<RequestContext>) => any;
/**
 ...
 */
type ExtendContextFn = (req: ExpressRequest) => Promise<RequestExtension> | RequestExtension;
type ErrorResponse = {
    error: string;
};
type MetaResponse = {
 ...
 * @todo Maybe we can add type limitations?
 */
type ResponseResultFn = (message: (Record<string, any> | Record<string, any>[]) | DataResult | ErrorResponse, extra?: {
    status: number;
}) => void | Promise<void>;
/**
...
type PreAggJobStatusResponse = PreAggJobStatusItem[] | PreAggJobStatusObject;
export { RequestContext, RequestExtension, ExtendedRequestContext, Request, SqlApiRequest, QueryRewriteFn, SecurityContextExtractorFn, ExtendContextFn, ResponseResultFn, MetaResponseResultFn, BaseRequest, RequestQuery, QueryRequest, PreAggsJobsRequest, PreAggsSelector, PreAggJob, PreAggJobStatusItem, PreAggJobStatusObject, PreAggJobStatusResponse, };
