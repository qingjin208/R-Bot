 ...
 */
type CheckAuthFn = (ctx: any, authorization?: string) => Promise<void | CheckAuthResponse> | CheckAuthResponse | void;
/**
 ...
 * auth logic.
 */
type CheckSQLAuthFn = (ctx: any, user: string | null, password: string | null) => Promise<CheckSQLAuthSuccessResponse> | CheckSQLAuthSuccessResponse;
/**
 ...
 */
type CanSwitchSQLUserFn = (current: string | null, user: string) => Promise<boolean> | boolean;
/**
 * Returns scopes tuple from a security context.
 */
type ContextToApiScopesFn = (securityContext?: any, scopes?: ApiScopesTuple) => Promise<ApiScopesTuple>;
export { CheckAuthInternalOptions, JWTOptions, CheckAuthFn, CheckSQLAuthSuccessResponse, CheckSQLAuthFn, CanSwitchSQLUserFn, ApiScopesTuple, ContextToApiScopesFn, };
