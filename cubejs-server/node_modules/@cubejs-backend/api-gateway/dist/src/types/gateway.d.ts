 ...
 */
import { QueryRewriteFn, ExtendContextFn } from './request';
import { JWTOptions, CheckAuthFn } from './auth';
import { RequestLoggerMiddlewareFn, ContextRejectionMiddlewareFn, ContextAcceptorFn, ContextToApiScopesFn } from '../interfaces';
 ...
 * this logic.
 */
type ScheduledRefreshContextsFn = () => Promise<UserBackgroundContext[]>;
...
export { UserBackgroundContext, ScheduledRefreshContextsFn, ApiGatewayOptions, };
