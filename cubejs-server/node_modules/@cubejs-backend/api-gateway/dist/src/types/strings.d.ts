 ...
 */
type FilterOperator = 'equals' | 'notEquals' | 'contains' | 'notContains' | 'in' | 'notIn' | 'gt' | 'gte' | 'lt' | 'lte' | 'set' | 'notSet' | 'inDateRange' | 'notInDateRange' | 'onTheDate' | 'beforeDate' | 'beforeOrOnDate' | 'afterDate' | 'afterOrOnDate' | 'measureFilter';
/**
...
export { RequestType, ResultType, ApiType, QueryType, MemberType, Member, TimeMember, FilterOperator, QueryTimeDimensionGranularity, QueryOrderType, ApiScopes, };
