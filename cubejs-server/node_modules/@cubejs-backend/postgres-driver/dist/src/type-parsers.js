...
const dateTypeParser = (val) => `${val}T00:00:00.000`;
exports.dateTypeParser = dateTypeParser;
 ...
 */
const timestampTzTypeParser = (val) => {
    ...
    if (offsetMs === 0) {
        ...
        return (0, exports.timestampTypeParser)(val.slice(0, tzIdx));
    }
...
exports.timestampTzTypeParser = timestampTzTypeParser;
