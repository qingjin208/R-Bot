...
exports.detectTypesFromTabular = void 0;
...
const integerRangeMatcher = (min, max) => (v) => {
...
function detectTypesFromTabular(rows) {
    if (rows.length === 0) {
    ...
    return fields.map(field => {
        ...
        const type = MATCHER_TYPES.find(matcherType => values.every(value => DbTypeValueMatcher[matcherType](value))) ?? 'text';
        return { name: field, type };
    });
}
exports.detectTypesFromTabular = detectTypesFromTabular;
//# sourceMappingURL=type-detection.js.map