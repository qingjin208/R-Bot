...
async function startProcess(pathToExecutable, config) {
    ...
    const cubeStore = (0, child_process_1.spawn)(pathToExecutable, {
        env,
        detached: false,
    });
    return new Promise((resolve, reject) => {
        ...
        const startupTimeout = (0, shared_1.withTimeout)(() => {
...
class CubeStoreHandler {
    ...
    async getBinary() {
        const pathToExecutable = (0, download_1.getBinaryPath)();
        if (!fs.existsSync(pathToExecutable)) {
            await (0, download_1.downloadBinaryFromRelease)();
            if (!fs.existsSync(pathToExecutable)) {
    ...
    async acquire() {
        ...
        const onExit = (code) => {
            ...
            this.cubeStoreStarting = new Promise((resolve, reject) => startProcess((0, download_1.getBinaryPath)(), {
                ...this.config,
                onExit,
            }).then((cubeStore) => {
